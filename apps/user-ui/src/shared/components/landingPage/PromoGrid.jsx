...
const PromoGrid = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 font-sans gap-4 px-10 pt-12 pb-8 bg-[#fff] text-gray-800 ">
        {/* Card 1  */}
        <div className="flex flex-col items-center justify-start bg-[#f5f5f7] p-4 rounded-lg">
          ...
          <div className="bg-blue-100 h-[300px] overflow-hidden rounded-none cursor-pointer flex flex-col ">
            {/* Image zone anchored at bottom */}
            <div className="flex-grow flex items-end">
              <div className="aspect-square w-full h-[260px]">
                <img
        ...
        <div className="flex flex-col items-center justify-start bg-[#f5f5f7] p-4 rounded-lg">
          ...
          <div className="bg-slate-300 h-[300px] overflow-hidden rounded-none cursor-pointer flex flex-col ">
            {/* Image zone anchored at bottom */}
            <div className="flex-grow flex items-end">
              <div className="aspect-square w-full h-[260px]">
                <img
