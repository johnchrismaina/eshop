...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-white z-[100] shadow-sm">
      <div className="w-[80%] py-1 m-auto flex items-center justify-between gap-8">
        {/* logo */}
        <div>
          <Link href="/">
            <Image
        ...
        <div className="flex items-center gap-4 shrink-0">
          <div className="relative group flex items-center gap-2 text-gray-600 p-2">
            {!isLoading && role === 'user' ? (
              ...
              <Link href="/login" className="flex flex-col items-start gap-0.5">
            ...
            {/* Floating panel */}
            <div className="absolute top-full left-0 mt-0 hidden w-64 rounded-md border border-gray-200 bg-white shadow-lg group-hover:block z-[110]">
              <div className="p-4">
