...
const Page = () => {
  ...
  const createDiscountCodeMutation = useMutation({
    mutationFn: async (data) => {
      await axiosProduct.post('/create-discount-code', data);
    },
    onSuccess: () => {
  ...
  const deleteDiscountCodeMutation = useMutation({
    mutationFn: async (discountId) => {
      await axiosProduct.delete(`/delete-discount-code/${discountId}`);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['shop-discounts'] });
              ...
              <div className="mt-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full border outline-none rounded-md border-gray-700 p-2 text-white bg-gray-800 hover:bg-gray-800 hover:text-white"
                    >
