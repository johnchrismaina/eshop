        ...
        <div className="w-[320px] border-r border-gray-800 bg-gray-950">
          ...
          <div className="divide-y divide-gray-900">
            {isLoading ? (
              ...
              <p className="text-center p-5">No conversation available yet!</p>
            ) : (
              chats.map((chat) => {
                const isActive =
              ...
              <div className="p-4 border-b border-gray-800 bg-gray-900 flex items-center gap-3">
                <Image
                  src={
                    ...
                    'https://ik.imagekit.io/johnchrismaina/avatar/6_t7jvvjy'
                  }
                  alt={selectedChat.user?.name}
                  width={40}
                  height={40}
                  className="rounded-full border w-[40px] h-[40px] object-cover border-gray-600"
                />
                <div>
