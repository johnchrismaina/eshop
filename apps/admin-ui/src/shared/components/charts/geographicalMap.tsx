...
const countryData = [
  ...
  { name: 'United Kingdom', users: 100, sellers: 20 },
  { name: 'Germany', users: 85, sellers: 15 },
  { name: 'Canada', users: 70, sellers: 10 },
  { name: 'Kenya', users: 120, sellers: 20 },
];
            ...
            geographies.map((geo) => {
              ...
              return (
                <Geography
                  ...
                  geography={geo}
                  onMouseEnter={(e) => {
                    setTooltipPosition({ x: e.pageX + 10, y: e.pageY - 160 }); // add offset
                    setHovered({
                      name: countryName,
                      users: match?.users || 0,
                  ...
                  onMouseMove={(e) => {
                    setTooltipPosition({ x: e.pageX + 10, y: e.pageY - 160 }); // keep offset }}
                  }}
