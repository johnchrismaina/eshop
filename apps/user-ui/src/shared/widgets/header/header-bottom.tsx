...
const HeaderBottom = () => {
  ...
  return (
    <div className="w-full transition-all duration-300 flex items-center justify-center h-[50px] ">
      <div className="w-[80%] relative mx-auto flex items-center justify-start gap-6 ">
        ...
        <div className="flex items-center gap-1">
          {navItems.map((i: NavItemsTypes, index: number) => (
            <Link
              className="px-3 py-2 font-medium text-sm text-gray-700 hover:text-gray-800 transition flex items-center"
              href={i.href}
              key={index}
            >
              {i.title}
