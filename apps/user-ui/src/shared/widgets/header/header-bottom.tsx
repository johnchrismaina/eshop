...
const HeaderBottom = () => {
  ...
  return (
    ...
    <div className="relative z-10 w-full transition-all duration-300 bg-[#fff] border-b border-gray-200 shadow-sm shadow-gray-300/10 ">
      <div className="w-full px-8 mx-auto pt-0.5 pb-0.5 relative flex items-center justify-center gap-5 h-full ">
        ...
        {/* Navigation Links */}
        <nav className="flex flex-1 items-center justify-start gap-3 ml-0 ">
