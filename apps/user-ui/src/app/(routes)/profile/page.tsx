...
const Page = () => {
  ...
  const queryTab = searchParams.get('activeTab') || 'profile';
    ...
    <div className="bg-gray-50 p-6 pb-14">
      <div className="md:max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-800">
            ...
            <span className="text-blue-600">
              {isLoading ? (
                <Loader2 className="inline-block animate-spin w-5 h-5" />
              ) : (
                `${user?.name || 'User'}`
              )}
            </span>{' '}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <StatCard title="Processing Orders" count={10} Icon={Truck} />
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-6">
          ...
          <div className="bg-white p-6 rounded-md shadow-sm border border-gray-100 w-full md:w-[55%]">
            ...
            {activeTab === 'Profile' && !isLoading && user ? (
              <div className="text-sm text-gray-700 flex flex-col gap-2 md:gap-4">
                {/* Avatar */}
